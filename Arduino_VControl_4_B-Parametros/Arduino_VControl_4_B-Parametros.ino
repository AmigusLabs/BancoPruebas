...
float calibration_factor =  12048.00 /   112; // 105246 ; //  lectura calibracion / kg -//- 1Kg = 1000g    // 12048.00/0.112
float romread = 0;
...
void setup() {
 ...
 pinMode(resetPin, INPUT_PULLUP);
  attachInterrupt(digitalPinToInterrupt(resetPin), reset_data, CHANGE);
